...
class CNN_ATT_SISL(Net):
    ...
    def forward(self, obs, state=None, info=None):
        ...
        # print(" state_memory_features3" , state_memory_features.shape)
        

        # Add positional encodings to state memory features
        # state_memory_features = state_memory_features.view(batch_size, seq_len, -1)
        # state_memory_features += pos_encodings.unsqueeze(0)
        
        # print("state_memory_features.shape", state_memory_features.shape)
        ...
        return policy_output.squeeze(0), None#value_output.squeeze(0)  # Adjust dimensions if necessary
