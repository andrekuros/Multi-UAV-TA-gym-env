# -*- coding: utf-8 -*-
"""
Created on Thu Apr 20 14:03:37 2023
...
if __name__ == "__main__":
    ...
    train_envs = DummyVectorEnv([PettingZooEnv(MultiDroneEnv()) for _ in range(1)])
    test_envs = DummyVectorEnv([PettingZooEnv(MultiDroneEnv()) for _ in range(1)])
